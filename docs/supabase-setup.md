...
This guide will help you set up Supabase as the database for OptiFlow.
...
4. Fill in the project details:
   - **Name**: optiflow (or your preferred name)
...
Supabase has built-in RLS. While OptiFlow handles auth with NextAuth, you can add an extra security layer:
...
2. Create a bucket: `optiflow-assets`
