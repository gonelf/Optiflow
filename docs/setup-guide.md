# OptiFlow Setup Guide

Complete setup instructions for getting OptiFlow running locally and deploying to production.
...
npx create-next-app@latest optiflow \
  --typescript \
  --tailwind \
  --app \
  --src-dir \
...
EMAIL_FROM="noreply@optiflow.com"
